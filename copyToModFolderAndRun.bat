...
"K:\SteamLibrary\steamapps\common\Source SDK Base 2013 Singleplayer\hl2.exe" -game "C:\Program Files (x86)\Steam\steamapps\sourcemods\mapbase_stalk_proj" -novid